...
import otelSDK from '@core/infrastructure/observability/instrumentation';
import { Logger } from 'nestjs-pino';
import { ILocaleService } from '@core/shared/i18n/locale.service.contract';
import { getExceptionFilters } from '@core/infrastructure/error/nestjs/http.exception.filter';
