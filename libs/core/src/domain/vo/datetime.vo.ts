import { RequireOnlyOne } from '@core/infrastructure/typescript/type';
import { newDayJs, now, parseDate } from '@core/infrastructure/utils/dayjs';
...
export type DateTimeProps = RequireOnlyOne<
  BaseDateTimeProps,
  'dayJsValue' | 'dateValue' | 'stringValue'
>;
